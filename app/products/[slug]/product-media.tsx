  ...
  return (
    ...
    >
      ...
      {resolvedThumbnailUrl && (
        <span className='bg-black-40 absolute left-1/2 top-1/2 flex size-9 -translate-x-1/2 -translate-y-1/2 items-center justify-center rounded-full'>
          <PlayIcon className='text-white-60 size-5' />
        </span>
      )}
    </div>
  )
